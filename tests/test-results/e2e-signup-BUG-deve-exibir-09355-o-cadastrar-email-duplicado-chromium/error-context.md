...
- Name: e2e\signup.spec.ts >> BUG: deve exibir E-mail ja cadastrado ao cadastrar email duplicado
- Location: e2e\signup.spec.ts:15:5
...
Locator: getByText('E-mail ja cadastrado')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('E-mail ja cadastrado')
...
- main:
  ...
  - text: Email
  - textbox "seu@email.com": duplicado1782275150967@email.com
  - text: Senha
  - textbox "••••••••": Senha123!
