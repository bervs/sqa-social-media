...
- Name: api\auth.spec.ts >> POST /auth/signin - deve retornar 401 com senha incorreta
- Location: api\auth.spec.ts:60:5
...
Expected: "Credenciais invalidas"
Received: "Credenciais inválidas"
```
