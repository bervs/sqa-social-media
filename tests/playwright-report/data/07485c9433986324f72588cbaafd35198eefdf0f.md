...
- Name: api\auth.spec.ts >> POST /auth/reset-password - deve retornar 404 para email nao cadastrado
- Location: api\auth.spec.ts:69:5
...
Expected: "Usuario nao encontrado"
